...
export const CondaPkgDrawer: React.FunctionComponent<ICondaPkgDrawerProps> = (
  ...
  const { packages, onClose } = props;

  // Add search state
  const [searchTerm, setSearchTerm] = React.useState('');

  // Track package modifications to prevent re-initialization
  // TODO: Add setPackageModifications back in when we have a way to track package modifications
  const [packageModifications] = React.useState<Map<string, string>>(new Map());
  ...
  const handleInstall = () => {
    ...
    console.log('CondaPkgDrawer - handleInstall:', selectedPackages);
  };
      ...
      <div style={Style.Drawer}>
        ...
        <div style={Style.SearchContainer}>
          ...
          <div style={Style.SearchInfo}>
            {/* TODO: Add CondaPkgList search info here */}
            <h1>CondaPkgList search info</h1>
          </div>
        </div>

        <div style={Style.Content}>
          {/* TODO: Add CondaPkgList here */}
          <h1>CondaPkgList</h1>
        </div>
